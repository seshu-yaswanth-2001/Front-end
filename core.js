...
// then along with GEC. it will create global objec and THIS keyword
...
// output: undefined
// explanation: the variable c is declared but not assigned to any value, so it is undefined.
...
// if var is declared in global space but if it is declared in the block scope then it will be shadowed by the block scope variable
